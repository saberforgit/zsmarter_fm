...
public class LogUtils {
    ...
    public static void v(String message) {
        if (LEVEL <= VERBOSE) {
            ...
            Log.v(getLogInfo(stackTraceElement) , message);
        }
    }
    ...
    public static void d(String message) {
        if (LEVEL <= DEBUG) {
            StackTraceElement stackTraceElement = Thread.currentThread().getStackTrace()[3];
            String tag = getDefaultTag(stackTraceElement);
            Log.d(getLogInfo(stackTraceElement) , message);
        }
    }
    ...
    public static void i(String message) {
        if (LEVEL <= INFO) {
            StackTraceElement stackTraceElement = Thread.currentThread().getStackTrace()[3];
            String tag = getDefaultTag(stackTraceElement);
            Log.i(getLogInfo(stackTraceElement) , message);
        }
    }
    ...
    public static void w(String message) {
        if (LEVEL <= WARN) {
            StackTraceElement stackTraceElement = Thread.currentThread().getStackTrace()[3];
            String tag = getDefaultTag(stackTraceElement);
            Log.w(getLogInfo(stackTraceElement) , message);
        }
    }
    ...
    public static void e(String tag, String message) {
        if (LEVEL <= ERROR) {
            ...
            Log.e(getLogInfo(stackTraceElement) , message);
        }
    }
